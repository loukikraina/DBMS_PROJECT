...
def student_view1(mi,pre,upd):
    ...
    label_0 = Label(root, text="{}'s Profile".format('Loukik'),width=20,font=("bold", 20)).grid(row = 0,column = 0,columnspan = 3)
    ...
    label_3_a = Label(root, text="4th",font=("bold", 10))
    
    
    label_4 = Label(root, text="Branch:- ",font=("bold", 12),fg = 'red')
    label_4_a = Label(root, text="COMPUTERS",font=("bold", 10))
    ...
    Button(root, text='Marks info',width=22,bg='brown',fg='white',command = mi).grid(row = 6, column = 0, rowspan = 2, stick = S, padx = 5, pady = 5)
